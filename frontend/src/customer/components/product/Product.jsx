...
const Secondfilters = [
  {
    ...
    name: "Price Range",
    options: [
      { value: "99-199", label: "99-199", checked: false },
      { value: "199-399", label: "199-399", checked: false },
      { value: "399-799", label: "399-799", checked: true },
      { value: "799-1499", label: "799-1499", checked: false },
      { value: "1499-2999", label: "1499-2999", checked: false },
    ],
  },
              ...
              <form className="hidden lg:block">
                <>
                  <div className="flex justify-between py-10">
                    {" "}
                    <h3 className="text-large font-bold opacity-50">Filters</h3>
                    <FilterListIcon />
                  </div>
